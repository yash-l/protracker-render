...
logger = logging.getLogger("Spectre.Adaptive")
...
# --- UI TEMPLATE (ADAPTIVE HERITAGE THEME) ---
HTML_BASE = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; outline: none; }
        ...
        /* COLLAPSED STATE */
        .sidebar.collapsed { width: var(--sidebar-collapsed); padding: 2rem 0.8rem; }
        ...
        .sidebar.collapsed .nav-item i { font-size: 1.2rem; margin: 0; }
        ...
        .brand i { font-size: 1.8rem; margin-right: 10px; min-width: 30px; }
        ...
        .menu { display: flex; flex-direction: column; gap: 0.5rem; flex: 1; margin-top: 1rem; }
        
        .menu-label { 
            font-family: 'Cinzel', serif; font-size: 0.65rem; color: rgba(224, 216, 200, 0.5); 
            text-transform: uppercase; letter-spacing: 0.2em; margin: 1rem 0 0.5rem 0.5rem;
        ...
        .nav-item i { width: 24px; text-align: center; font-size: 1rem; transition: font-size 0.3s; }

        .user-panel {
            border-top: 1px solid rgba(197, 160, 89, 0.3);
            padding-top: 1.5rem; margin-top: auto; display: flex; align-items: center; gap: 12px;
        ...
        /* ADJUST MAIN WHEN COLLAPSED */
        body.mini-sidebar .main { margin-left: var(--sidebar-collapsed); }

        /* MOBILE OPTIMIZATION */
        @media (max-width: 768px) {
            .sidebar { width: var(--sidebar-collapsed); } /* Default to collapsed icons on mobile */
            .sidebar:not(.collapsed) { width: 80%; box-shadow: 100px 0 0 rgba(0,0,0,0.5); }
            .sidebar.collapsed .brand-text { display: none; }
            .main { margin-left: var(--sidebar-collapsed); padding: 2rem 1.5rem; }
            .toggle-btn { display: none; } /* Hide toggle, use tap interaction if needed or keep sticky */
        ...
        .login-box { width: 100%; max-width: 450px; padding: 4rem; background: var(--surface); border: 1px solid var(--gold); box-shadow: 0 20px 40px rgba(26, 47, 35, 0.15); position: relative; }
    ...
    <script>
        function toggleSidebar() {
            ...
            localStorage.setItem('spectre_sidebar', isCollapsed ? 'collapsed' : 'expanded');
        }

        // Init State
        document.addEventListener("DOMContentLoaded", () => {
            const state = localStorage.getItem('spectre_sidebar');
            // Default on mobile is collapsed (mini), Default on desktop is expanded
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="/dashboard" class="brand">
            ...
            <span class="brand-text">SPECTRE</span>
        </a>
        ...
        <div class="menu">
            ...
            <a href="/intelligence" class="nav-item {{ 'active' if active_page == 'intelligence' else '' }}">
                <i class="fas fa-fingerprint"></i> <span class="nav-text">INTELLIGENCE</span>
            </a>
            <a href="/logs" class="nav-item {{ 'active' if active_page == 'logs' else '' }}">
                <i class="fas fa-scroll"></i> <span class="nav-text">ARCHIVE</span>
            </a>
            
            <div class="menu-label">Protocol</div>
            <a href="/settings" class="nav-item {{ 'active' if active_page == 'settings' else '' }}">
                <i class="fas fa-cogs"></i> <span class="nav-text">CONFIG</span>
            </a>
        ...
        <div class="user-panel">
            ...
            <a href="/logout" class="logout-btn" style="color:var(--gold);"><i class="fas fa-power-off"></i></a>
        </div>
    </div>
    {% endif %}
