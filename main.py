...
<head>
    ...
    <style>
        :root {
            ...
            --danger: #8B0000;
            --sidebar-width: 260px;
            --sidebar-mini: 60px; /* Slimmer mobile sidebar */
        }
        ...
        * { box-sizing: border-box; outline: none; -webkit-tap-highlight-color: transparent; }
        ...
        /* FORMS & INPUTS (FIXED BLUE AUTOFILL) */
        input, select, textarea {
            width: 100%; padding: 12px; border: 1px solid var(--border); background: #FCFAF5;
            font-family: 'Lora', serif; font-size: 16px; /* 16px prevents iOS zoom */
            color: var(--text-main); border-radius: 0; /* Professional sharp edges */
        ...
        @media (max-width: 900px) {
            ...
            /* Content Adjustment */
            .main { margin-left: var(--sidebar-mini); padding: 2rem 1rem; width: calc(100% - var(--sidebar-mini)); }
            ...
            /* Login Mobile */
            .login-box { padding: 2rem !important; width: 90% !important; border: 1px solid var(--gold); }
        }
        ...
        .mono { font-family: 'Cormorant Garamond', serif; font-size: 1.1rem; font-style: italic; color: #888; }
...
async def login():
    ...
    <div class="login-wrap">
        <div class="login-box">
            ...
            <p style="color:var(--text-muted); margin-bottom:2.5rem; text-align:center; font-style:italic;">Private Intelligence Ledger</p>
...
async def dashboard():
    ...
    <div class="stats-grid">
        <div class="stat-card"><div class="stat-label">TOTAL TARGETS</div><div class="stat-val">{total_count}</div><div style="font-size:0.7rem; color:var(--text-muted);">QUOTA: {me['max_targets']} ALLOWED</div></div>
        <div class="stat-card"><div class="stat-label">ACTIVE UPLINKS</div><div class="stat-val" style="color:var(--success);">{online_count}</div><div style="font-size:0.7rem; color:var(--text-muted);">CURRENTLY ONLINE</div></div>
